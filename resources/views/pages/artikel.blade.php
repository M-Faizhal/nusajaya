    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                <h1 class="display-4 fw-bold mb-3">Artikel & Tips</h1>
...
<!-- Artikel Categories Filter -->
<section class="py-4 bg-light">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="artikel-categories text-center">
...
<section class="py-5">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 mb-4 artikel-item" data-category="{{ strtolower(str_replace(['&', ' '], ['', ''], $article['category'])) }}">
                                <article class="artikel-card bg-white rounded-4 shadow-sm overflow-hidden h-100">
                    ...
                    <div class="card-body p-4">
                        <div class="artikel-meta mb-3 d-flex align-items-center justify-content-between">
                            <div>
                                @switch($article['category'])
                                    @case('Tips & Tricks')
                        ...
                        <h3 class="artikel-title fw-bold mb-3">
                        ...
                        <p class="artikel-excerpt text-muted mb-4">{{ $article['excerpt'] }}</p>                        <div class="artikel-footer d-flex align-items-center justify-content-between">
                            ...
                            <a href="{{ route('artikel.show', $article['slug']) }}" class="btn btn-outline-primary btn-sm">
...
<style>
    ...
    .artikel-categories .btn {
        transition: all 0.3s ease;
    }

    .artikel-categories .btn.active {
        background-color: var(--primary-color);
        border-color: var(--primary-color);
        color: white;
    }

    .artikel-image-placeholder {
