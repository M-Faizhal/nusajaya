...
@section('title', $article['title'] . ' - Blog Nusajaya')
            ...
            <div class="col-lg-8">
                <div class="article-navigation d-flex justify-content-between align-items-center">
                    <div class="nav-previous">
                        ...
                        @if($prevSlug)
                        <a href="{{ route('blog.show', $prevSlug) }}" class="btn btn-outline-primary">
                    ...
                    <div class="nav-back">
                        <a href="{{ route('blog') }}" class="btn btn-primary">
                            <i class="fas fa-th-large me-2"></i>Kembali ke Blog
                        </a>
                    </div>

                    <div class="nav-next">
                        @if($nextSlug)
                        <a href="{{ route('blog.show', $nextSlug) }}" class="btn btn-outline-primary">
